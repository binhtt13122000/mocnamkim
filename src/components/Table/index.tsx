...
const HasuraTable = (props: ITable & { children?: React.ReactNode }) => {
    ...
    const total = (data as any)
        ? (data as any)[`${entity}_aggregate`]
            ? (data as any)[`${entity}_aggregate`]["aggregate"]
                ? (data as any)[`${entity}_aggregate`]["aggregate"]["count"]
                : 0
            : 0
        : 0;

    const emptyRows = (data as any)
        ? paging.limit - ((data as any)[entity] ? (data as any)[entity].length : 0)
        : 0;
            ...
            <Box sx={{ width: "100%" }}>
                <Paper
                    sx={{
                        mb: 2,
                        overflowX: "auto",
                        maxWidth: { md: "calc(100vw - 250px - 2vw)", xs: "90vw" },
                        // maxWidth: "100%",
                    }}
                >
                    <Toolbar
                            ...
                            <TableBody>
                                ...
                                {isLoading ? (
                                    ...
                                    <React.Fragment>
                                        ...
                                        />
                                        {emptyRows > 0 && emptyRows === paging?.limit && (
                                            <TableRow
                                                style={{
                                                    height: 53 * emptyRows,
                                                }}
